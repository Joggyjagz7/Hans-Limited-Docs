...
{
  "status": "success",
  "message": "Ping! API is operational.",
...
| **403 Forbidden** | IP Not whitelisted | Add your static IPs to the whitelist section of your Hans Dashboard |
| **500 Internal Server Error** | Our issue. | Check the Han Limited [Status Page](#) for known outages. |

---

> 💡 **Tip:**  
> If none of these fixes resolve your issue, try regenerating your API key from your Hans Dashboard and repeat the setup steps.
